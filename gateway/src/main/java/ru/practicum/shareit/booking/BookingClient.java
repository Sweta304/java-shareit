...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> bookItem(long userId, BookingIncomingDto bookingIncomingDto) {
    ...
    public ResponseEntity<Object> getBookingsByOwnerItems(long userId, String state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state,
                "from", from,
                "size", size
