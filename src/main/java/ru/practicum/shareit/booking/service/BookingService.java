...
public interface BookingService {
    BookingDto addBooking(Booking booking, Long owner) throws ItemNotAvailableException, ItemNotFoundException, IncorrectBookingException, UserNotFoundException;
