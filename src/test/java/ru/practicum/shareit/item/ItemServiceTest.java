...
public class ItemServiceTest {
    ...
    void addCommentEmptyBookings() {
        ...
        assertThrows(IncorrectBookingException.class, () -> itemService.addComment(comment, 1L, 1L));
    }
    ...
    void addCommentTextEmpty() {
        ...
        comment.setText("");
        assertThrows(IncorrectCommentException.class, () -> itemService.addComment(comment, 1L, 1L));
    ...
    void addCommentUserNotFound() throws Exception {
        ...
        CommentDto actual = itemService.addComment(comment, 1L, 1L);
