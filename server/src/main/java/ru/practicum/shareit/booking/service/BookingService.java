...
public interface BookingService {
    ...
    List<BookingDto> getAllBookings(Long owner, String state, Integer from, Integer size) throws UserNotFoundException, IncorrectBookingStatusException;

    List<BookingDto> getAllBookingsByOwnerItems(Long owner, String state, Integer from, Integer size) throws UserNotFoundException, IncorrectBookingStatusException;
}
